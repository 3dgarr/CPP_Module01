...
// 		{
// 			// std::string a = filename + ".replace"
// 			outfile.open((filename + ".replace").c_str(), std::ios::out | std::ios::trunc ); //only works on macOS with the +, to make it work on Linux, comment out "filename +"
